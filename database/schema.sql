...
CREATE TABLE IF NOT EXISTS company_settings (
  id INT AUTO_INCREMENT PRIMARY KEY,
  title VARCHAR(255) NOT NULL DEFAULT 'Welcome to CinemaBook',
...
INSERT INTO company_settings (title, description, features, opening_hours) 
VALUES (
  'Welcome to CinemaBook',
  'Your ultimate destination for movie experiences. Book tickets, discover new films, and enjoy the magic of cinema.',
  'Premium viewing experience,Comfortable seating,Latest blockbusters,Easy online booking',
